  ...
  return (
    <div className=' bg-box-color'>
      <div className='container'>
        <div className='DownloadMovieBox   border-radius-0-8-rem'>
          <div className='row  description'>
            <div className='col-lg-6 col-md-12 '>
              <h3 className='text-color-white fs-3-2-rem fw-lighter '>
                Download Your Movies Watch Offline.Enjoy on Your Mobile{" "}
              </h3>{" "}
              <p className='mt-5 first-text-color fs-1-8-rem '>
              ...
              <div className='mt-5 d-flex gap-5 '>
                <button className='px-5 py-2 icon-color  fw-bold fs-2-0-rem bg-black-color border-radius-0-4-rem'>
                  {" "}
                  HD 4 K{" "}
                </button>{" "}
