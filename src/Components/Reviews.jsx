    ...
    <div className='container'>
      ...
      <div className='row bg-box-color p-5 gap-5 border-radius-0-8-rem '>
        <div className='col-lg-5 col-md-12 '>
          <p className='text-color-for-paraghraph fs-2-6-rem fw-bold'>
            {" "}
            Review "Army Of The Dead"{" "}
          </p>{" "}
          <p className='text-color-sec fs-1-8-rem'>
            {" "}
            Write a review for this movie.It will be posted on this page.{" "}
          </p>{" "}
          <p className='text-color-sec fs-1-8-rem fw-bold mt-4'>
            {" "}
            Select Rating{" "}
          </p>{" "}
          <select
            className='  py-3  px-5 border-radius-0-8-rem sec-bg-color text-color-white fs-1-8-rem w-100 '
            value={rate}
            onChange={(e) => {
          ...
          <div>
            ...
            />
            <button
              className='w-100 mt-5 border-radius-0-4-rem cursor-p bg-btn-color text-color-white text-center p-3 fs-1-8-rem'
        ...
        <div className='col-lg-6 col-md-12 px-5 commentsBox'>
          <p className='text-color-for-paraghraph fs-2-8-rem fw-bold'>
            {" "}
            Reviews{" "}
          </p>{" "}
          {reviews.map((review) => (
