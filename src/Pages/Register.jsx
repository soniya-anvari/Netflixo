...
function Register() {
    ...
    return ( <
        ...
        <
        label className = 'text-color-sec  fw-bold fs-1-8-rem' > Fullname <
        /label> <
        input name = 'name'
        type = 'text'
        ...
        <
        button type = "submit"
        className = 'p-4 fs-1-8-rem cursor-p bg-btn-color text-color-white d-flex justify-content-center  gap-3  mt-3 align-items-center  border-radius-0-4-rem' > < FaArrowRightToBracket / > Sign Up < /button> <
        p className = 'text-color-sec m-auto mt-4 fs-2-0-rem' > Already have an account ? < Link to = '/login'
        className = 'first-text-color fw-bold me-3' > Login < /Link> < /p >
        <
        /form>  < /
        div >
    )
