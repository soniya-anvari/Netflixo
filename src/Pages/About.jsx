...
function About() {
    return ( <
        ...
        p className = 'fs-1-6-rem fs-lighter text-color-for-paraghraph mt-3' > Lorem Ipsum is simply dummy text of the printing and < /p> < /
        div > <
        ...
        p className = 'fs-1-6-rem fs-lighter text-color-for-paraghraph mt-3' > Completely free, without registration!Lorem Ipsum is simply < /p>
