...
function Login() {
    const [fields, setFields] = useState({ grant_type: "", username: "", password: "" })
    ...
    return ( <
        ...
        <
        button type = "submit"
        className = 'p-4 fs-1-8-rem  cursor-p bg-btn-color text-color-white d-flex justify-content-center  gap-3  mt-3 align-items-center  border-radius-0-4-rem' > < FaArrowRightToBracket / > Login < /button>

        <
        p className = 'text-color-sec m-auto mt-4 fs-2-0-rem' >
        Don 't have an account ? < Link to = "/register"
        className = 'first-text-color fw-bold me-3 ' > Sign Up < /Link> < /
        p >
